...
@router.post(
    ...
    responses={
        ...
        415: {
            "model": ErrorResponse,
            "description": (
                "`LETTER_UNSUPPORTED_TYPE` / `LETTER_CORRUPT_FILE` / `LETTER_MIME_MISMATCH`."
            ),
        },
...
async def generate_reply(
    ...
    if payload.action_id:
        ...
        # Prefer actions explicitly flagged reply_needed; fall back to all.
        _ = [a for a in actions if a.reply_needed] or actions
